...
//	
//	protected Vector3[,] GetRandomPosition(GameObject[] target, int number)
//	{
...
//			
//				if (RestrictionTreePlacement.Distanse(tempPosition, targetTranform))
//				{
